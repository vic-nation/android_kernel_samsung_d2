...
static u8 touchkey_keycode[] = {KEY_MENU, KEY_HOME, KEY_BACK};
...
//	gpio_keys_platform_data.nbuttons = 3;
	...
	taos_pdata.als_int = gpio_rev(GPIO_ALS_INT);

	a2220_i2c_gpio_data.sda_pin = gpio_rev(A2220_I2C_SDA);
	a2220_i2c_gpio_data.scl_pin = gpio_rev(A2220_I2C_SCL);
	a2220_data.gpio_wakeup = gpio_rev(MSM_AUD_A2220_WAKEUP);
	msm8960_a2220_configs[0].gpio = gpio_rev(A2220_I2C_SDA);
	msm8960_a2220_configs[1].gpio = gpio_rev(A2220_I2C_SCL);
#ifdef CONFIG_KEYBOARD_CYPRESS_TOUCH_236
